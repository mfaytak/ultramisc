...
for rf in glob.glob(rawfile_glob_exp):
	...
	barename = os.path.split(parent)[1]
	...
	wav = os.path.join(parent,str(barename + ".ch1.wav"))
	tg = os.path.join(parent,str(barename + ".ch1.TextGrid"))
	sync = os.path.join(parent,str(barename + '.sync.txt'))
	sync_tg = os.path.join(parent,str(barename + ".sync.TextGrid"))
	idx_txt = os.path.join(parent,str(barename + ".idx.txt"))
